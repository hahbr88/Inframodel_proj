...
DB_HOST="$(ssm "$SSM_PREFIX/db-host")"
DB_PORT="$(ssm "$SSM_PREFIX/db-port")"
...
WRITE_DATABASE_URL=mysql+asyncmy://$DB_USER_URL:$DB_PASSWORD_URL@$DB_HOST:$DB_PORT/$DB_NAME_URL
READ_DATABASE_URL=mysql+asyncmy://$DB_USER_URL:$DB_PASSWORD_URL@$DB_HOST:$DB_PORT/$DB_NAME_URL

...
class CommandRepositoryPort(Protocol):
    ...
    async def create_user(self, username: str, password_hash: str) -> Any: ...

    async def update_user_password(self, user_id: int, password_hash: str) -> Any | None:
        ...

    async def deactivate_user(self, user_id: int) -> Any | None: ...
